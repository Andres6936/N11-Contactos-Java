...
public class PanelDatosContacto extends JPanel
{
	...
	public PanelDatosContacto( )
	{
		...
		GridBagConstraints gbcI = new GridBagConstraints( 0, 0, 1, 1, 0, 0, GridBagConstraints.WEST,
				GridBagConstraints.HORIZONTAL, new Insets( 5, 10, 5, 5 ), 0, 0 );
		GridBagConstraints gbcD = new GridBagConstraints( 1, 0, 1, 1, 1, 0, GridBagConstraints.WEST,
