...
public class DialogoEstadisticas extends JDialog implements ActionListener
{
	...
	public void reqFuncOpcion1( )
	{
		...
		{
			JOptionPane.showMessageDialog( this, "Debe ingresar el valor", "Directorio Contactos",
		...
		else
		{
			...
			{
				JOptionPane.showMessageDialog( this, "El valor ingresado debe ser un número", "Directorio Contactos",
						JOptionPane.ERROR_MESSAGE );
			}
