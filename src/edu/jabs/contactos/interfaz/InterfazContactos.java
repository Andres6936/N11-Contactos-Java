...
public class InterfazContactos extends JFrame
{
	...
	public void agregarContacto( String nombre, String telefono, String direccion, String email )
	{
		...
		{
			JOptionPane.showMessageDialog( this, "Ya hay un contacto con ese nombre", "Error",
	...
	public void buscarContacto( )
	{
		...
		if ( nombreBuscado != null )
		{
			...
			{
				JOptionPane.showMessageDialog( this, "No se encontró un contacto con ese nombre", "Buscar",
	...
	public void agregarContacto( )
	{
		...
		if ( "".equals( nombre ) )
		{
			JOptionPane.showMessageDialog( this, "Debe indicar un nombre", "Directorio Contactos",
					JOptionPane.ERROR_MESSAGE );
		}
		else
		{
			...
			{
				JOptionPane.showMessageDialog( this, "Ya existe un contacto con el nombre " + nombre,
						"Directorio Contactos", JOptionPane.ERROR_MESSAGE );
			}
		}
	}
