...
public class Contacto implements Comparable
{
	...
	public int darPesoIterativo( )
	{
		...
		while ( p != null )
		{
			...
			{
				// Es una hoja, luego debemos sacar de la pila el último subárbol allí
				// almacenado
	...
	/**
	 * Implementación iterativa para localizar un contacto en el árbol que comienza
	 * en este nodo
	 * 
	...
	public boolean esOrdenado( )
	{
		if ( esHoja( ) )
			...
			return der.esOrdenado( ) && nombre.compareTo( der.darMenor( ).darNombre( ) ) < 0 && izq.esOrdenado( )
					&& nombre.compareTo( izq.darMayor( ).darNombre( ) ) > 0;
	}
