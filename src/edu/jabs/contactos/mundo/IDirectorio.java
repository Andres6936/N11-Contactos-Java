...
/**
 * Esta interfaz especifica los servicios que deben ser proporcionados por el
...
public interface IDirectorio
{
	...
	/**
	 * Retorna las estadísticas asociadas con la estructura interna de información
	 * del directorio
	 * 
	 * @return Las estadísticas asociadas con la estructura interna de información
	 *         del directorio
	 */
