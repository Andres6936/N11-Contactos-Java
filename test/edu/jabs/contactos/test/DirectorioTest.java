...
import edu.jabs.contactos.mundo.Directorio;
import edu.jabs.contactos.mundo.IDirectorio;
...
public class DirectorioTest extends TestCase
{
	 ...
	 * Directorio. <br>
	 * <b> Objetivo: </b> Probar que el método Directorio() crea el directorio de
	 * forma correcta . <br>
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * buscarContacto. <br>
	 * <b> Objetivo: </b> Probar que el método buscarContacto() sea capaz de
	 * encontrar un contacto dado en el directorio. <br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Al buscar un contacto previamente adicionado, éste debe ser encontrado.
	 * <br>
	 ...
	 * <b> Objetivo: </b> Probar que el método agregarContacto() sea capaz de
	 * agregar correctamente un contacto al directorio. <br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * <b> Objetivo: </b> Probar que el método eliminarContacto() sea capaz de
	 * eliminar un contacto del directorio. <br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * <b> Objetivo: </b> Probar que el método darListaContactos() retorne la lista
	 * de contactos ordenada ascendentemente. <br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Al pedir la lista de contactos esta debe ser retornada en orden
	 * ascendente.
	 */
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * darEstadisticas. <br>
	 * <b> Objetivo: </b> Probar que el método darEstadisticas() retorne las
	 * estadísticas asociadas con el árbol de contactos correctamente. <br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Al pedir las estadíssticas, estas deben ser retornadas completas y con el
	 * valor correcto.
	 */
