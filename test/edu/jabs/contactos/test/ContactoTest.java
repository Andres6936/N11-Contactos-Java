package edu.jabs.contactos.test;

import java.util.ArrayList;
import java.util.Collection;

import edu.jabs.contactos.mundo.Contacto;
import edu.jabs.contactos.mundo.ContactoRepetidoException;
...
public class ContactoTest extends TestCase
{
	...
	/**
	 * Crea un escenario donde al contacto inicial le inserta un contacto menor,
	 * teniendo el árbol ya dos nodos
	 */
	...
	/**
	 * Crea un escenario con un árbol de contactos de 5 nodos teniendo el árbol ya
	 * tres nodos
	 */
	 ...
	 * <b> Objetivo: </b> Probar que el método Contacto() se capaz de crear
	 * correctamente el contacto. <br>
	 ...
	 * <b> Objetivo: </b> Probar que el método insertar() inserte correctamente un
	 * contacto en el árbol de contactos. <br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Al insertar un contacto en un árbol compuesto sólo de un contacto se debe
	 * aumentar el peso y altura del árbol.
	 */
	 ...
	 * contacto en el árbol de contactos. <br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Al insertar un contacto en un árbol compuesto por la raíz y el hijo
	 * izquierdo, se debe aumentar el peso y altura del árbol.
	 */
	 ...
	 * contacto en el árbol de contactos. <br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Al insertar dos contacto en un árbol compuesto por la raíz y sus dos
	 * hijos, se debe aumentar el peso y altura del árbol.
	 */
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * insertar. <br>
	 * <b> Objetivo: </b> Probar que el método insertar() arroje excepción cuando se
	 * trate de adicionar un contacto repetido. <br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Al insertar un contacto previamente existente en el árbol se debe arrojar
	 * excepción.
	 */
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * buscarIterativo. <br>
	 * <b> Objetivo: </b> Probar que el método buscarIterativo() busque
	 * correctamente los contactos dados. <br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * buscar. <br>
	 * <b> Objetivo: </b> probar que el método buscar() busque correctamente los
	 * contactos dados. <br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Al buscar un contacto que no existe se debe retornar null. <br>
	 * 2. Al buscar un contacto que existe éste debe ser retornado.
	...
	/**
	 * Prueba los algoritmos que retornan el mayor y el menor del árbol <b> Métodos
	 * a probar: </b> <br>
	 * darMenor, darMayor. <br>
	 * <b> Objetivo: </b> Probar que los métodos darMayor() y darMenor() retornen
	 * correctamente los contactos con los nombres que sean mayor y menor
	 * (lexicograficamente) respectivamente. <br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Al pedir el elemento menor del árbol se debe retornar el nombre menor
	 * lexicograficamente. <br>
	 * 2. Al pedir el elemento mayor del árbol se debe retornar el nombre mayor
	 * lexicograficamente.
	 */
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * eliminar. <br>
	 * <b> Objetivo: </b> Probar que el método eliminar() elimine correctamente un
	 * elemento del árbol. <br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Al eliminar un elemento del árbol, el peso del árbol debe disminuir en 1.
	 * <br>
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * inorden. <br>
	 * <b> Objetivo: </b> Probar que el método inorden() retorne correctamente el
	 * recorrido del árbol en inorden. <br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Al pedir el recorrido en inorden del árbol, los elementos deben ser
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * contarHojas. <br>
	 * <b> Objetivo: </b> Probar que el método contarHojas() realice el conteo
	 * correcto del número de hojas del árbol. <br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Se sabe que el número de hojas de un árbol es X. Al pedir el número de
	 * hojas se debe obtener X.
	 */
	...
	/**
	 * Prueba el método para contar el número de ocurrencias de un elemento dentro
	 * del árbol <b> Métodos a probar: </b> <br>
	 * contarOcurrencias. <br>
	 * <b> Objetivo: </b> Probar que el método contarOcurrencias() cuente
	 * correctamente las apariciones de un elemento en el árbol. <br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Al pedir el número de ocurrencias de un elemento que existe en el árbol,
	 * se debe obtener 1. <br>
	 * 2. Al pedir el número de ocurrencias de un elemento que no existe en el
	 * árbol, se debe obtener 0.
	 * 
	 */
